package com.applepie.xhs.user.biz.service.impl;
...
import com.applepie.common.util.ParamUtils;
import com.applepie.framework.biz.context.holder.LoginUserContextHolder;
import com.applepie.jackson.utils.JsonUtil;
import com.applepie.xhs.oss.api.FileFeignApi;
import com.applepie.xhs.user.biz.constant.RedisKeyConstants;
import com.applepie.xhs.user.biz.constant.RoleConstants;
import com.applepie.xhs.user.biz.domain.dataobject.RoleDO;
import com.applepie.xhs.user.biz.domain.dataobject.UserDO;
import com.applepie.xhs.user.biz.domain.dataobject.UserRoleRelDO;
import com.applepie.xhs.user.biz.domain.mapper.RoleDOMapper;
import com.applepie.xhs.user.biz.domain.mapper.UserDOMapper;
import com.applepie.xhs.user.biz.domain.mapper.UserRoleRelDOMapper;
import com.applepie.xhs.user.biz.enums.ResponseCodeEnum;
import com.applepie.xhs.user.biz.enums.SexEnum;
import com.applepie.xhs.user.biz.model.vo.UpdateUserInfoReqVO;
import com.applepie.xhs.user.biz.rpc.DistributedIdGeneratorRpcService;
import com.applepie.xhs.user.biz.rpc.OssRpcService;
...
public class UserServiceImpl implements UserService {
    ...
    public Response<?> updateUserInfo(UpdateUserInfoReqVO updateUserInfoReqVO) {
        ...
        if (StringUtils.isNotBlank(xiaohashuId)) {
            Preconditions.checkArgument(ParamUtils.checkXiaohashuId(xiaohashuId), ResponseCodeEnum.XHS_ID_VALID_FAIL.getErrorMessage());
    ...
    public Response<Long> register(RegisterUserReqDTO registerUserReqDTO) {
        ...
        // 否则注册新用户
        // 获取全局自增的小哈书 ID
//        Long xiaohashuId = redisTemplate.opsForValue().increment(RedisKeyConstants.XHS_ID_GENERATOR_KEY);
        ...
        UserDO userDO = UserDO.builder()
                ...
                .nickname("基米" + xiaohashuId + "前辈") // 自动生成昵称, 如：小红薯10000
